...
Partial Class login
    ...
    Protected Sub Btnlogin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnlogin.Click
        ...
        cmdstr = "select feedback_year,feedback_sem from feedback_schedule where is_on=1 and dept_name='" & id & "'"
        ...
        Else
            ...
            lblmsg.Text = "Feedback is temporary restricted for " & ddluname.SelectedItem.Text
        End If
