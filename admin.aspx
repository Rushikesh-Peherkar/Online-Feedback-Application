...
<form id="form2" runat="server">
 ...
 <div id="apDiv1" 
  ...
  <div id="apDiv9" align="center">
    ...
    <br />
    <div id="apDiv10">
        <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="#6600FF" style="float:right" NavigateUrl="~/startfeedback.aspx">Start Feedback</asp:HyperLink></div>
    ...
    <ul id="MenuBar1" class="MenuBarHorizontal">
     ...
     <li><a href="comment.aspx" style="font-size: medium; font-weight: bold; color: #FFFFFF; background-color: #666666"> Comment&nbsp; | </a></li>
      <li><a href="#" class="MenuBarItemSubmenu" style="font-size: medium; font-weight: bold; color: #FFFFFF; background-color: #666666"> &nbsp; Account</a>
        <ul>
          <li><a href="account.aspx" style="font-size: medium; font-weight: bold; color: #FFFFFF; background-color: #666666">Change Password</a></li>
          <li><a href="login.aspx" style="font-size: medium; font-weight: bold; color: #FFFFFF; background-color: #666666">Logout</a></li>
        </ul>
      </li>
    </ul>
  </div>
